package net.kayn.codex_of_champions.spells.eldritch;
...
import net.kayn.codex_of_champions.Registry.EffectRegistry;
...
public class PersonaBondSpell extends AbstractSpell {
    private final ResourceLocation spellId = new ResourceLocation(CodexOfChampions.MODID, "persona_bond");
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        MinecraftForge.EVENT_BUS.post(new SpellHealEvent(entity, entity, healing, this.getSchoolType()));
        entity.heal(healing);
        entity.addEffect(new MobEffectInstance(EffectRegistry.PersonaBond.get(), getEffectDuration(entity, spellLevel), 0, false, false, true));
