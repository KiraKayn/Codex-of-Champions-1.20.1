...
public class VampiricCharmCurio extends CurioBaseItem {
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid, ItemStack stack) {
        ...
        attr.put(AttributeRegistry.BLOOD_SPELL_POWER.get(), new AttributeModifier(uuid1, slotContext.identifier() + "BLOOD_SPELL_POWER", 0.1, AttributeModifier.Operation.MULTIPLY_BASE));
        attr.put(ALObjects.Attributes.LIFE_STEAL.get(), new AttributeModifier(uuid1, slotContext.identifier() + "LIFE_STEAL", 0.05, AttributeModifier.Operation.ADDITION));
        return attr;
    }
}
