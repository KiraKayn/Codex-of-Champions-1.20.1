...
public class AzureAnlaceCurio extends SimpleDescriptiveCurio {
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid, ItemStack stack) {
        ...
        attr.put(AttributeRegistry.HOLY_SPELL_POWER.get(), new AttributeModifier(uuid1, slotContext.identifier() + "HOLY_SPELL_POWER", 0.1, AttributeModifier.Operation.MULTIPLY_BASE));
        attr.put(ALObjects.Attributes.HEALING_RECEIVED.get(), new AttributeModifier(uuid1, slotContext.identifier() + "HEALING_RECEIVED", 0.1, AttributeModifier.Operation.MULTIPLY_BASE));
        return attr;
    }
}
